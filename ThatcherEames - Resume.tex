...
\begin{document}
    ...
    {\color{secondaryColor}\section{Education}}  
        ...
        \begin{twocolentry}
            {\color{secondaryColor}\textbf{GPA 3.30}}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Relevant Coursework:} Machine Learning Algorithms, Data Structures, Systems Programs, Linear Algebra, Software Development, Object Oriented Programming, Data Science in Python, Vector Calculus
            \end{highlights}
        \end{onecolentry}
